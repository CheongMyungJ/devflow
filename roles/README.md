...
| [Reviewer](reviewer.md) | Step, Artifact, Worker 의 작업 노트, deterministic 결과 | Reviewer 출력 (`reviewer-output.schema.json`) — 시스템이 GateResult 로 기록한다 | 읽기 (실행해서 확인할 수 있다. 쓰기는 Workspace 밖에 자신이 만든 임시 디렉터리 하나에만) | 관찰만 |
